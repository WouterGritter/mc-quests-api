...
public class QuestLevelDownEvent extends QuestProgressEvent {
    ...
    public QuestLevelDownEvent(UUID playerUuid, QuestType questType, QuestProgress questProgress, int previousLevel, double previousProgress) {
